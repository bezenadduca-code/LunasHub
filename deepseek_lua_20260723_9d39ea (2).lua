...
-- Function to check and classify a model as Vine or GroundBulb (WITH FIX)
local function gvEvaluateAndHighlight(child)
    if not child:IsA("Model") then return end
    
    -- === FIX: EXPLICITLY IGNORE MAP AND PLAYER FOLDERS ===
    if child.Name == "Map" then return end
    if child.Name == "Players" then return end
    
    -- === FIX: IGNORE MODELS THAT ARE ACTUAL PLAYERS (HAS HUMANOID) ===
