...
local function abDotSetState(on)
    ...
    _abDotBtn.BackgroundColor3 = on
        and Color3.fromRGB(220, 40, 40)   -- red  = AB active
        or  Color3.fromRGB(60, 60, 60)    -- grey = AB off
    _abDotBtn.Text = on and "AB" or "ab"
    _abDotBtn.TextColor3 = on
...
local function abDotCreate()
    ...
    _abDotBtn.Size                  = UDim2.new(0, 32, 0, 32)
    _abDotBtn.Position              = UDim2.new(1, -48, 0.5, -16)
    _abDotBtn.AnchorPoint           = Vector2.new(0, 0)
    _abDotBtn.BackgroundColor3      = Color3.fromRGB(60, 60, 60)
    _abDotBtn.BackgroundTransparency = 0
    _abDotBtn.BorderSizePixel       = 0
    _abDotBtn.Text                  = "ab"
    _abDotBtn.TextColor3            = Color3.fromRGB(140, 140, 140)
    _abDotBtn.TextSize              = 9
    ...
    svc.Input.InputChanged:Connect(function(inp)
        if not _abDotDragStart then return end
